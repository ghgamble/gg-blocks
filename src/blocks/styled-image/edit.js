...
export default function Edit({ attributes, setAttributes }) {
	...
	return (
		<>
			<InspectorControls>
				<PanelBody
					title={__('Image Settings', 'gg-blocks')}
					initialOpen={true}
				>
					<RangeControl
						label={__('Image Width (%)', 'gg-blocks')}
						value={width}
						onChange={(value) =>
					...
					<RangeControl
						label={__('Border Radius (px)', 'gg-blocks')}
						value={borderRadius}
						onChange={(value) =>
					...
					<SelectControl
						label={__('Aspect Ratio', 'gg-blocks')}
						value={aspectRatio}
						options={[
					...
					<ToggleControl
						label={__('Apply Drop Shadow', 'gg-blocks')}
						checked={applyShadow}
						onChange={(value) =>
							setAttributes({ applyShadow: value })
						}
					/>
				</PanelBody>
			</InspectorControls>
