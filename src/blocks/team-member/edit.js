...
export default function Edit( { attributes, setAttributes } ) {
	...
	const onSelectPhoto = ( media ) => {
		...
		setAttributes( {
			photoUrl: media.url,
			// If name is empty, seed it from Media Library data for convenience/ADA.
			name: name || media.alt || media.alt_text || media.title || '',
		} );
	};
	...
	return (
		<div { ...blockProps }>
			...
			<RichText
				...
				placeholder={ __(
					'Full LinkedIn URL (e.g., https://linkedin.com/in/username)',
					'gg-blocks'
				) }
